...
<div class="container">
    ...
    <header class="search-header">
        ...
        <div class="search-bar">
            <input type="text" placeholder="Search for anything..." aria-label="Search" on:keypress={
                (event) => {
                    if (event.key === 'Enter') {
    ...
    <main class="results">
        ...
        <div class="result-card">
            ...
            <p class="url">{simplifyUrl(result.url)}</p>
            <p class="description">{shortenText(result.description, 100)}</p>
        </div>
        {/each}
    </main>
</div>
